    ...
    <div className="app">
      ...
      <section className='main-page'>
        ...
        <div className='cuadritos'>
          <div onClick={()=>{navigate('/volumenes/1')}} className='cuadro a'><img src={iconob1} alt="construction icon" /><h2>VOLUMEN I</h2></div>
          <div onClick={()=>{navigate('/volumenes/2')}} className='cuadro b'><img src={iconob2} alt="conexion icon" /><h2>VOLUMEN II</h2></div>
          <div onClick={()=>{navigate('/volumenes/3')}} className='cuadro c'><img src={iconob3} alt="coding icon" /><h2>VOLUMEN III</h2></div>
        </div>
      </section>
