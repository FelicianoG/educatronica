...
export default function Volumen({inicial}) {
    ...
    const [ selectedSection, setSelectedSection ] = useState('kit');
    ...
    function handlePortal(e, target){
        setPortal(true)
    }
        ...
        <main id='volume-container' className={volumen.color}>
            ...
            <section className='cuadros-stack'>
                <div className='cuadro-row'>
                    <div id='kit' onClick={()=>{ handlePortal(volumenes[id-1].kit) }} className='cuadro-item'>
