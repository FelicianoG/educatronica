...
export default function Modulo({inicial}) {
                    ...
                    objetos:[
                        {
                            ...
                            recursos:[{tipo:'Presentación', url:context.semaforoPDFURL}]
                        },
                        {
    ...
    <div className='App'>
        ...
        {portal && <VideoModal videoURL={videoURL} section={selectedSection} content={volumenes[id-1]} color={volumenes[id-1].bgcolor} handleClose={handleClosePortal}/>}
    </div>
  )
}